#===
fitalgorithm_sum.jl - Variational fitting algorithm for summing multiple tensor trains

This file contains code derived from ITensorMPS.jl and ITensorTDVP.jl
Original source: https://github.com/ITensor/ITensorTDVP.jl
The fit function for summing multiple MPS/MPO with coefficients uses ITensorMPS.alternating_update
and follows the pattern established in ITensorTDVP.jl.
